...
async function makeGeminiRequest(apiKey: string, prompt: string): Promise<string> {
  if (!apiKey) throw new Error("Gemini API key is not configured — add GOOGLE_API_KEY_1 and GOOGLE_API_KEY_2 to Doppler");
